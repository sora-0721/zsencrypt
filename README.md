...
你可以前往 <a href="https://github.com/zeoseven/zsencrypt/releases">Release</a> 直接下载 ZSEncrypt_Private-Build.zip 即可获得已经构建好的**私有化版本**，它是**完全静态的**，保留了其中的文档，并且所有资源都将在本地获取，当然，除非你想要使用最新版本。
