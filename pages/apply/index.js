    ...
    return (
        <>
            ...
            <div id="q-steps2" style={{ display: 'none' }}>
                ...
                <div className="step1Hide step2Show">
                    ...
                    <div className="Center text-end mt-5">
                        <button className="mainBtn btn btn-q step1-main-btn" onClick={() => { configStepClick(); }}>
            ...
            <div id="q-steps3" style={{ display: 'none' }}>
                ...
                <p className="mb-2">这是可信 CA 颁发证书所必要的阶段，您可能需要： <a href="/documents/#1-3" target="_blank">文档 - 验证域名所有权</a> 。</p>
                ...
                <div className="step1Hide step2Hide step3Show">
                    ...
                    <div className="itemBox">
                        <div className="Center text-center">
                            <span className="mainBtn verifyStepBtn btn btn-q fw-bold me-3" onClick={() => { verifyStepClick() }}>
                ...
                <div className="step1Hide step2Hide step3Hide step4Show">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 mt-5">
                            <p className="text-center"><button onClick={() => { window.location.reload() }} className="btn-q fw-bold">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-clockwise" viewBox="0 0 16 16">
