    ...
    return (<>
        ...
        <Page>
            ...
            <div className="documents">
                ...
                <div className="mb-3">ZSEncrypt 中的一切高级方法和限制都基于 ZSEncrypt 的证书颁发机构 Let's Encrypt 的 <a href="https://letsencrypt.org/zh-cn/docs/#%E7%94%A8%E6%88%B7%E4%BF%A1%E6%81%AF" target="_blank" rel="noopener nofollow">高级用户信息</a> 和 <a href="https://letsencrypt.org/zh-cn/docs/rate-limits/" target="_blank" rel="noopener nofollow">速率限制</a> ，这是不可避免的防止滥用措施。</div>
                <div className="fw-bold mb-5">你还可以前往 <a href="https://github.com/zeoseven/zsencrypt/" target="_blank">github.com</a> 并阅读其中的 README.md 来部署一个私有的 ZSEncrypt 。</div>
                ...
                <div>
                    <H2>主机记录格式</H2>
                    <p>ZSEncrypt 无法智能的猜到一切裸域名，因为它们可能是多级的，所以需要输出完整主机记录，否则可能导致提供的记录缺失。</p>
                    <p><b>固定规则公式：</b></p>
                    <pre>需要验证的 TXT 主机记录 - 结尾的您注册的域名 = 最终添加到 DNS 的主机记录</pre>
                ...
                <div>
                    ...
                    <p>但如果清除了浏览器数据或者更换了设备或浏览器，虽然 ZSEncrypt 会自动在没有账户的浏览器中再创建一个新的 账户 B ，但即便在 账户 A 验证的所有权，在 账户 B 也不会存在，不过可以使用 <a href="#数据迁移 - 在其它浏览器或设备极速续期">数据迁移</a> 来做到。</p>
