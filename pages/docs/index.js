        ...
        <SmallPage name="文档">
            <div className="documents">
                ...
                <div>
                    ...
                    <img src="/static/data/docs/01.webp" loading='lazy' />
                    ...
                    <p>输出的信息看起来像这样：</p>
                    <img src="/static/data/docs/02.webp" loading='lazy' />
                    ...
                    <img src="/static/data/docs/03.webp" loading='lazy' />
                ...
                <div>
                    ...
                    <p><qd>权威 DNS 根域名 ≠ 注册域名</qd>，因为权威 DNS 的根域名也可以是另一个域的子域名，如 sub.eu.org ，通常来说，没有 eu.org 的权威 DNS 控制权，但拥有 sub.eu.org 的权威 DNS 控制权，那么 sub.eu.org 就是权威 DNS 根域名，这时候验证 www.sub.eu.org 的 <b>_acme-challenge.www.sub.eu.org</b> 时，添加的 TXT 记录应为 <b>_acme-challenge.www</b> 而不是 <b>_acme-challenge.www.sub</b> 。</p>
                ...
                <div>
                    ...
                    <p>比如在 账户 A 中验证了域名 zeoseven.com 和 *.zeoseven.com 的所有权(成功颁发证书) ，那么 Let's Encrypt 账户会记住，<qd>并在续期时要求和申请时一样的验证凭据</qd>，通常是 <qd>DNS 中使用相同的 TXT 记录值</qd> 。</p>
