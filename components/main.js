            ...
            <nav className={`navbar navbar-expand-${s}`}>
                <div className={`container-fluid fs-14 px-${b}-5`}>
                    <a className="navbar-brand me-5" href="/">
                        <img src='https://webstatic.zeoseven.com/static/logo/zsencrypt/v2/logoa.png' className='logo' />
                    </a>
...
export const Footer = () => {
    return (
        <footer className="footer-div p-5">
            ...
            <p className='my-2'>{`© 2024-${new Date().getFullYear()} 瑶清秋 & 温魏 | GPLv3`}</p>
            <div>
...
export const Page = ({ type, children }) => {
    return (
        <main className='container pt-5 px-4'>
